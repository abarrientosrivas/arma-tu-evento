(function(){
  ...
  angular.module("imageupload", [])
    ...
    .directive("inputFile",  ['generic_image_processing_functions', function(generic_image_processing_functions) {
      return {
        require: "ngModel",
        link: function (scope, element, attrs, ngModel) {

          var file_upload_element = new angular.element("<input type='file'>");
